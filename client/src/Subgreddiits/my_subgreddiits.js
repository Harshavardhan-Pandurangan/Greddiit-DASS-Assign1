...
export default function MySubgreddiits(props) {
    ...
    const createSubGreddiit = () => {
        ...
        axios
            .post(
                `http://localhost:3001/subgreddiits/create/${localStorage.id}`,
                send_data,
                headers
            )
            .then((res) => {
        ...
        <div>
            ...
            <List>
                ...
                <ListItem disablePadding>
                    <ListItemButton
                        onClick={() => {
                            navigate(`/posts/saved/${localStorage.id}`);
                        }}
                    >
                        <ListItemIcon>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button
                            onClick={() => {
                                handleDeleteClose();
                                let req_path = `http://localhost:3001/subgreddiits/delete/${localStorage.id}`;
                                let req_body = {
